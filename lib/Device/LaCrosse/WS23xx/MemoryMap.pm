...
0354:10 Min_Indoor_Temperature_datetime [s]      _time_convert($BCD)
035E:10 Max_Indoor_Temperature_datetime [s]      _time_convert($BCD)
...
0381:10 Min_Outdoor_Temperature_datetime [s]     _time_convert($BCD)
038B:10 Max_Outdoor_Temperature_datetime [s]     _time_convert($BCD)
...
03AE:10 Min_Windchill_datetime [s]               _time_convert($BCD)
03B8:10 Max_Windchill_datetime [s]               _time_convert($BCD)
...
03DC:10 Min_Dewpoint_datetime [s]                _time_convert($BCD)
03E6:10 Max_Dewpoint_datetime [s]                _time_convert($BCD)
...
0401:10 Min_Indoor_Humidity_datetime [s]         _time_convert($BCD)
040B:10 Max_Indoor_Humidity_datetime [s]         _time_convert($BCD)
...
041F:10 Min_Outdoor_Humidity_datetime [s]        _time_convert($BCD)
0429:10 Max_Outdoor_Humidity_datetime [s]        _time_convert($BCD)
...
04A3:10 Max_Rain_24hour_datetime [s]             _time_convert($BCD)
...
061E:10 Min_Pressure_datetime [s]                _time_convert($BCD)
...
should be interpreted as a time_t (seconds since the Epoch),
but also used in the B<Countdown> field in which it will be
a number between 0 and 128.5.
